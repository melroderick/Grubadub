...
public class MiddleManTest {
  ...
  public static void init() {
    ...
    chipotle = new Restaurant("0", "Chipotle", c, new LatLng(0.1, 0.1), 5, 1, "A", "");
    fiveGuys = new Restaurant("1", "Five Guys", c, new LatLng(5.0, 5.0), 4, 7, "B", "");
    subway = new Restaurant("2", "Subway", c, new LatLng(3.2, 2.7), 3, 9, "C", "");
    soban = new Restaurant("3", "Soban", c, new LatLng(1.2, 4.3), 4.3f, 40, "D", "");
