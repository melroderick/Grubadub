...
public class GoogleRouteTest {
  ...
  private GoogleRoute portland2Seatttle;
  private GoogleRoute portland2Providence;
  ...
  public void setUp() {
    ...
    portland2Providence =
        (new GoogleRouteFinder()).getRoute(portland, "Providence, RI");
  }
  ...
  public void testDistanceFrom() {
    ...
    assertEquals(
        portland2Seatttle.distanceFrom(kelso),
        kelso.distanceFrom(guessGMapsPoint),
        .05);
  }

  /*@Test
  public void testDistanceFromTime() {
